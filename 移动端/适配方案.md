...
> 理想中的视口。目的是解决在布局视口下页面元素过小的问题，显示在理想视口中的页面具有最理想的宽度，用户无需进行缩放。所谓理想视口，即<u>**页面绘制区域可以完美适配设备宽度的视口大小**</u>，不需要出现滚动条即可正常查看网站的所有内容，且文字图片清晰，如所有iphone的理想视口宽度都为320px，安卓设备的理想视口有320px、360px等等。
>
...
> 为了让移动端页面获得更好的显示效果，我们必须让布局视口、视觉视口都尽可能等于理想视口，所以我们一般会设置`width=device-width`，这就相当于**<u>让布局视口等于理想视口</u>**；设置`initial-scale=1.0`，相当于<u>**让视觉视口等于理想视口**</u>；
>
